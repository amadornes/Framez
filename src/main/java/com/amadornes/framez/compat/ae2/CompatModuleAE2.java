...
public class CompatModuleAE2 extends CompatModule {
    ...
    public void preInit(FMLPreInitializationEvent ev) {
        ...
        FramezApi.inst().getMotorRegistry().registerMotor(MotorProviderAE2.inst);
    ...
    private void preInitClient() {
        ...
        FramezApi.inst().getMotorRegistry().registerSpecialRenderer(new RenderSpecialAE2());
    }
    ...
    public void init(FMLInitializationEvent ev) {
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(GameRegistry.findBlock(ModInfo.MODID, References.Names.Registry.MOTOR + "."
                + MotorProviderAE2.inst.getId()), "rCr", "CcC", "rCr", 'c', FramezBlocks.motorcore, 'C', "circuitBasic", 'r',
