...
public class GuiButton16 extends GuiButton {
    ...
    protected static final ResourceLocation buttonTextures = new ResourceLocation(ModInfo.MODID, "textures/gui/button16.png");

    public GuiButton16(int buttonId, int x, int y, int widthIn, String buttonText) {

        super(buttonId, x, y, widthIn, 16, buttonText);
    }
