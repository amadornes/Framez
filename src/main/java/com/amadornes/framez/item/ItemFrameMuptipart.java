...
public class ItemFrameMuptipart extends JItemMultiPart {
    ...
    public String getUnlocalizedName() {
        ...
        return "item." + References.Names.Unlocalized.FRAME;
    }
    ...
    public void addInformation(ItemStack item, EntityPlayer player, List list, boolean shift) {
        ...
        if (modifiers.length == 0) {
            ...
            for (IFrameModifierProvider m : modifiers) {
                ...
                maxMoved = Math.max(maxMoved, m.getMaxCarriedBlocks());
            }
        }

        list.add(I18n.format("framez.hud.maxmoved") + ": " + (maxMoved == -1 ? 3 : maxMoved));
    }
