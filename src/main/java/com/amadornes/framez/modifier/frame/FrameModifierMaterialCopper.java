...
public class FrameModifierMaterialCopper implements IFrameModifierMaterial {

    @Override
    public String getType() {

        return References.Modifier.MATERIAL_COPPER;
    }
    ...
    public Class<? extends ITrait> getTraitClass() {
        ...
        return TFrameCopper.class;
    }

    public static abstract class TFrameCopper extends JTrait<IFrame> implements IFrame {

        @Override
        public IIcon getBorderIcon() {

            return IconSupplier.copper_border;
        }

        @Override
        public IIcon getBorderPanelIcon() {

            return IconSupplier.copper_border_panel;
        }

        @Override
        public IIcon getCrossIcon() {

            return IconSupplier.copper_cross;
        }

        @Override
        public IIcon getSimpleIcon() {

            return IconSupplier.copper_simple;
        }
